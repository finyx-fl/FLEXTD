...
/**
 * flextd-physique v2.0 - ULTRA PHYSICS ENGINE merged into Flextd v1
...
// Legacy simple physics kept for backward compat with FlextdEngine v1
...
FlextdEngine.prototype.enableUltraPhysics = function(opts={}){
  ...
  this.ultraCar = null;
  console.log('%c[Flextd v2 ULTRA PHYSICS] FlextdWorld + SPH + Cloth + Car Ready','color:#00ffff;background:#000;padding:4px');
